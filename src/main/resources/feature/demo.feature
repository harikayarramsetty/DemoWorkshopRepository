...
@valid
Scenario Outline: Setting the quantity of the product to 2
When I enter username as '<username>' and password as '<password>' and I  go to apparel and shoes and click on any product and change the quantity to '2'
